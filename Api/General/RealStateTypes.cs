...
{
    public class RealStateTypes : EndpointWithoutRequest<List<NameResponse>>
    {

        ApplicationDbContext _context;
        public RealStateTypes(ApplicationDbContext context)
        {
            _context = context;
        }
        ...
        {
            Verbs(Http.GET);
            Routes("/Api/General/RealStateTypes");
